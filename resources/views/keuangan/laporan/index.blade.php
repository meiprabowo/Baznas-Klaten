                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                          <div class="card card-default card-md mb-4">
                              ...
                              <div class="card-body">
                        <form action="{{ route('keuangan.mutasi.laporanbukubesar') }}" enctype="multipart/form-data">
                          ...
                          <div class="card card-default card-md mb-4">
                              ...
                              <div class="card-body">
                        <form action="{{ route('keuangan.mutasi.neraca') }}" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12">
                          <div class="card card-default card-md mb-4">
                              ...
                              <div class="card-body">
                        <form action="{{ route('keuangan.mutasi.realisasianggaran') }}" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12">
                          <div class="card card-default card-md mb-4">
                              ...
                              <div class="card-body">
                        <form action="{{ route('keuangan.mutasi.perubahan') }}" enctype="multipart/form-data">
