                                ...
                                <div class="breadcrumb-action justify-content-center flex-wrap">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> Jurnal Memorial  </li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    <div class="project-search order-search  global-shadow mt-10">
                                        <form action="{{ route('keuangan.mutasi.searchkeuangan') }}" class="order-search__form">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('keuangan.mutasi.exportkeuangan',['keyword'=>request('keyword')]) }}">  <button type="button" class="btn btn-warning btn-xs btn-squared">Export</button></a>

                                    <a href="{{ route('keuangan.mutasi.createkeuangan') }}">  <button type="button" class="btn btn-info btn-xs btn-squared">Tambah Data</button></a>
</div>
                                </div>
                            </div>
                     ...
                     <tr>
                        ...
                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap float-end">
                                            ...
                                            @endif
                                               ...
                                               <li>
                                                   <a href="{{ route('keuangan.mutasi.editkeuangan', $d->id) }}" class="edit">
                                                       <i class="uil uil-edit"></i>
                                                   </a>
                                                 
                                               </li>
                                               <li>
                                                   <a href="{{ route('keuangan.mutasi.destroykeuangan', $d->id) }}"  onclick="return confirm('Apakah Anda Yakin ?');"  class="remove">
