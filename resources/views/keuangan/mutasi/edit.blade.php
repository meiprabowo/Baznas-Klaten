...
@endif
         <div class="card">
                    <div class="card-header">
                        <h5>Form Edit Jurnal Memorial</h5>
                    </div>


                    <div class="card-body">
                    <form method="POST"  action="{{ route('keuangan.mutasi.updatekeuangan', $data->id) }}" enctype="multipart/form-data">
                            @csrf                             @method('PUT')
                            <div class="row g-3">
                            ...
                            <div class="row g-3">
                                <div class="col-md-5 mb-3">
                                    ...
                                    <input class="form-control" id="validationDefault01" type="text" name="jumlah" value="{{ number_format($data->jumlah, 0, ',', '.') }}" >
                                </div>
