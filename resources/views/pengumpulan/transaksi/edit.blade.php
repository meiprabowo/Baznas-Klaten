...
@endif
         <div class="card">
                    ...
                    <div class="card-body">
                    <form method="POST"  action="{{ route('pengumpulan.pengumpulan.edit', $data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                             ...
                             <div class="row g-3">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="dm-select ">
                                        ...
                                        @foreach($sumber as $key => $dd)
                                        <option value="{{ $dd->id }}" {{ $dd->id == $data->debet ? 'selected' : '' }} > {{ $dd->uraian }}</option>
                                        @endforeach
                                      </select>
                                    </div>  
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="dm-select ">
                                        ...
                                        <option value="{{ $t->id }}" {{ $t->id == $data->kredit ? 'selected' : '' }} > {{ $t->uraian }}</option>
                                        @endforeach
                                      </select> 
                                    </div> 
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="validationDefault01" type="text" name="jumlah"  value="{{ number_format($data->jumlah, 0, ',', '.') }}" placeholder="Jumlah" oninput="formatNominal(this)">
                                </div>
                          
                                <div class="col-md-8 mb-3">
                                    <label class="form-label" for="validationDefault02">Keterangan</label>
                                    <input class="form-control" id="validationDefault01" type="text" name="keterangan" placeholder="Keterangan" value="{{$data->keterangan}}" >
                                </div>
                            </div>
