                        ...
                        <div class="userDatatable orderDatatable sellerDatatable global-shadow mb-30 py-30 px-sm-30 px-20 radius-xl w-100">
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('pengumpulan.pengumpulan.laporanexport',['keyword'=>request('keyword'),'bulan'=>request('bulan')]) }}">  <button type="button" class="btn btn-warning btn-xs btn-squared">Export</button></a>
</div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                          <div class="card card-default card-md mb-4">
                              <div class="card-header">
                                 <h6>Ikhtisar Laporan Penerimaan</h6>
                              </div>
                              <div class="card-body">
                              <div class="form-group">
                              <form action="{{ route('pengumpulan.pengumpulan.laporan') }}" method="GET" >
<div class="col-sm-5">
