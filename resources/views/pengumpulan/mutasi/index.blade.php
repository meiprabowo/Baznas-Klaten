                            ...
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    <div class="project-search order-search  global-shadow mt-10">
                                        <form action="{{ route('pengumpulan.mutasi.searchpengumpulan') }}" class="order-search__form">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('pengumpulan.mutasi.exportpengumpulan',['keyword'=>request('keyword')]) }}">  <button type="button" class="btn btn-warning btn-xs btn-squared">Export</button></a>

                                    <a href="{{ route('pengumpulan.mutasi.createpengumpulan') }}">  <button type="button" class="btn btn-info btn-xs btn-squared">Tambah Data</button></a>
</div>
                                </div>
                            </div>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap float-end">
                                            ...
                                            <li>
                                                   <a href="{{ route('pengumpulan.mutasi.editpengumpulan', $d->id) }}" class="edit">
                                                       <i class="uil uil-edit"></i>
                                                   </a>
                                                 
                                               </li>
                                               <li>
                                                   <a href="{{ route('pengumpulan.mutasi.destroypengumpulan', $d->id) }}"  onclick="return confirm('Apakah Anda Yakin ?');"  class="remove">
