                    ...
                    <div class="col-lg-12">
                        <div class="shop-breadcrumb">
                            ...
                            <div class="breadcrumb-main">
                                <h4 class="text-capitalize breadcrumb-title">Data Muzaki / Mustahik Lembaga </h4>
                            ...
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    <div class="project-search order-search  global-shadow mt-10">
                                        <form action="{{ route('pengumpulan.muzaki.searchlembaga') }}" class="order-search__form">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('pengumpulan.muzaki.exportlembaga',['keyword'=>request('keyword')]) }}">  <button type="button" class="btn btn-warning btn-xs btn-squared">Export</button></a>

                                    <a href="{{ route('pengumpulan.muzaki.importlembaga') }}">  <button type="button" class="btn btn-primary btn-xs btn-squared">Import Data</button></a>

                                    <a href="{{ route('pengumpulan.muzaki.createlembaga') }}">  <button type="button" class="btn btn-info btn-xs btn-squared">Tambah Data</button></a>
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                <ul class="orderDatatable_actions mb-0 d-flex flex-wrap float-end">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('pengumpulan.muzaki.editlembaga', $d->id) }}" class="edit">
                                                            <i class="uil uil-edit"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('pengumpulan.muzaki.destroylembaga', $d->id) }}"  onclick="return confirm('Apakah Anda Yakin ?');"  class="remove">
