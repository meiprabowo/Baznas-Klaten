                    ...
                    <div class="col-lg-12">
                        <div class="shop-breadcrumb">
                            ...
                            <div class="breadcrumb-main">
                                <h4 class="text-capitalize breadcrumb-title">Upload Data Muzaki</h4>
                                <div class="breadcrumb-action justify-content-center flex-wrap">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#"><i class="las la-home"></i>Muzaki</a></li>
                           ...
                           <figure class="feature-cards7 feature-cards7--1">
                              <div class="banner-card banner-card-border">
                                 ...
                                 <h5 class="banner-card__title">
                                    Form Import Data Muzaki Lembaga
                                    </h5>
                                 </div>
                                 <div class="banner-card__body">
                                    <p>
                                        
                                    <form method="POST" action="{{ route('pengumpulan.muzaki.importstorelembaga') }}" enctype="multipart/form-data">
                                    @csrf
                                    Upload Data Muzaki Lembaga <small class="display-block">Migrasi harus menggunakan format yang telah ditentukan yaitu dalam bentuk xls / xlsx.                               <span><br/>
                                    <code class="text-danger"> Download template <a href="{{ route('pengumpulan.muzaki.downloadlembaga') }}" target="_blank"> ==> <b>DOWNLOAD</b> <== </a></code>
    </small>
                                    </p>
                                 </div>
