                           ...
                           <figure class="feature-cards7 feature-cards7--1">
                              <div class="banner-card banner-card-border">
                                 ...
                                 <h5 class="banner-card__title">
                                    Form Import Data Muzaki Perseorangan
                                    </h5>
                                 </div>
                                 <div class="banner-card__body">
                                    <p>
                                        
                                    <form method="POST" action="{{ route('pengumpulan.muzaki.importstore') }}" enctype="multipart/form-data">
                                    @csrf
                                    Upload Data Muzaki Perseorangan <small class="display-block">Migrasi harus menggunakan format yang telah ditentukan yaitu dalam bentuk xls / xlsx.                               <span><br/>
                                    <code class="text-danger"> Download template <a href="{{ route('pengumpulan.muzaki.download') }}" target="_blank"> ==> <b>DOWNLOAD</b> <== </a></code>
    </small>
                                    </p>
                                 </div>
