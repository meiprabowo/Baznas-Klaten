                            ...
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    <div class="project-search order-search  global-shadow mt-10">
                                        <form action="{{ route('proposal.proposal.searchproses') }}" class="order-search__form">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('proposal.proposal.prosesupload') }}">
                                        <button type="button" class="btn btn-warning btn-xs btn-squared">Upload Data</button>
                                    </a>
</div>
                                </div>
                            </div>
                            <form method="POST" action="{{ route('proposal.proposal.prosesbagi') }}" enctype="multipart/form-data">
                                  @csrf
