                    ...
                    <div class="col-lg-12">
                        <div class="shop-breadcrumb">
                            ...
                            <div class="breadcrumb-main">
                                <h4 class="text-capitalize breadcrumb-title">Data Proposal Perseorangan</h4>
    ...
    <div class="col-xxl-3 col-sm-6  col-ssm-12 mb-25">
                     ...
                     <div class="ap-po-details ap-po-details--luodcy  overview-card-shape radius-xl d-flex justify-content-between">
                        <div class=" ap-po-details-content d-flex flex-wrap justify-content-between w-100">
                         <a href="#"><div class="ap-po-details__titlebar">
                              <p>Total Porposal</p>
                            ...
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    <div class="project-search order-search  global-shadow mt-10">
                                        <form action="{{ route('proposal.proposal.psearch') }}" class="order-search__form">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('proposal.proposal.pexport',['keyword'=>request('keyword')]) }}">  <button type="button" class="btn btn-warning btn-xs btn-squared">Export</button></a>
                                    <a href="{{ route('proposal.proposal.pcreate','P') }}">  <button type="button" class="btn btn-primary btn-xs btn-squared">Tambah Data </button></a>
</div>
                                </div>
                            </div>
                                            ...
                                            <div class="project-progress text-end">
                                                ...
                                                <div class="dropdown  dropdown-click ">
                                                    ...
                                                    <button class="btn-link border-0 bg-transparent p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('proposal.proposal.pedit', $d->id) }}">Edit</a>
                                                            ...
                                                            @endif
                                                            <a class="dropdown-item" href="{{ route('proposal.proposal.pdestroy', $d->id) }}" onclick="return confirm('Apakah Anda Yakin ?');" >Hapus Data</a>
                                                        </div>
                                                </div>
                                            </div>
