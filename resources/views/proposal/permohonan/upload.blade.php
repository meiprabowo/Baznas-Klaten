                           ...
                           <figure class="feature-cards7 feature-cards7--1">
                              <div class="banner-card banner-card-border">
                                 ...
                                 <h5 class="banner-card__title">
                                    Form Upload Data Perseorangan
                                    </h5>
                                 </div>
                                 <div class="banner-card__body">
                                    <p>
                                        
                                    <form method="POST" action="{{ route('proposal.proposal.importperseorang') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <code class="text-danger"> Download template <a href="https://docs.google.com/spreadsheets/d/19BXxdotKkwVDr08DKY8nkTyBaB8Vsi4A/edit?usp=sharing&ouid=106302929100988856231&rtpof=true&sd=true" target="_blank"> ==> <b>DOWNLOAD</b> <== </a></code>
    </small>
                                    </p>
                                 </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                           <figure class="feature-cards7 feature-cards7--1">
                              <div class="banner-card banner-card-border">
                                 <div class="banner-card__top align-center-v justify-content-between">
                                 <h5 class="banner-card__title">
                                    Form Upload Data Lembaga
                                    </h5>
                                 </div>
                                 <div class="banner-card__body">
                                    <p>
                                 <form method="POST" action="{{ route('proposal.proposal.importlembaga') }}" enctype="multipart/form-data">
                                    @csrf
                                 <div class="banner-card__body">
                                    <p>Upload Data Lembaga <small class="display-block">Migrasi harus menggunakan format yang telah ditentukan yaitu dalam bentuk xls / xlsx.                               <span><br/><code class="text-danger"> Download template <a href="https://docs.google.com/spreadsheets/d/1DeMP8idO-mD1JcQ68PeKVowDf_OMNKIA/edit?usp=sharing&ouid=106302929100988856231&rtpof=true&sd=true" target="_blank"> ==> <b>DOWNLOAD</b> <== </a></code> </small></p>
                                 </div>
                                 <div class="banner-card__bottom  align-center-v justify-content-between">
                                 <div class="col-md-12 mb-3">
