                    ...
                    <div class="col-lg-12">
                        <div class="shop-breadcrumb">
                            ...
                            <div class="breadcrumb-main">
                                <h4 class="text-capitalize breadcrumb-title">Data Proposal Lembaga</h4>
                            ...
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    <div class="project-search order-search  global-shadow mt-10">
                                        <form action="{{ route('proposal.proposal.lsearch') }}" class="order-search__form">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('proposal.proposal.lexport',['keyword'=>request('keyword')]) }}">  <button type="button" class="btn btn-warning btn-xs btn-squared">Export</button></a>
                                    <a href="{{ route('proposal.proposal.lcreate','L') }}">  <button type="button" class="btn btn-primary btn-xs btn-squared">Tambah Data </button></a>
</div>
                                </div>
                            </div>
                                                ...
                                                <div class="dropdown  dropdown-click ">
                                                    ...
                                                    <button class="btn-link border-0 bg-transparent p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        ...
                                                        <div class="dropdown-default dropdown-bottomLeft dropdown-menu-right dropdown-menu--dynamic dropdown-menu">
                                                            <a class="dropdown-item" href="{{ route('proposal.proposal.ledit', $d->id) }}">Edit</a>
                                                            ...
                                                            @endif
                                                            <a class="dropdown-item" href="{{ route('proposal.proposal.ldestroy', $d->id) }}" onclick="return confirm('Apakah Anda Yakin ?');" >Hapus Data</a>
                                                        </div>
                                                </div>
                                            </div>
