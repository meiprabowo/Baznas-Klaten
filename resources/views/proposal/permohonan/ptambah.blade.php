    ...
    $('#subprogram').change(function(){
        ...
        if(kecamatanId){
         ...
         <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('proposal.proposal.pstore') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="validationDefault02">Kecamatan</label>
                                        ...
                                        <select class="form-control px-15" id="kecamatan" id="select-search" name="kecamatan" id="exampleFormControlSelect1" required="">
