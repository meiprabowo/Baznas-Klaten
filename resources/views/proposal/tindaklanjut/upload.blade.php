                           ...
                           <figure class="feature-cards7 feature-cards7--1">
                              <div class="banner-card banner-card-border">
                                 ...
                                 <div class="banner-card__body">
                                    ...
                                    <form method="POST" action="{{ route('proposal.proposal.lanjutimport') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <code class="text-danger"> Download template <a href="{{ route('proposal.proposal.lanjutexport') }}" target="_blank"> ==> <b>DOWNLOAD</b> <== </a></code>
    </small>
                                    </p>
                                 </div>
