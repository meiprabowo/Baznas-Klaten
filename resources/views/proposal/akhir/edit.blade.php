        ...
        if(kecamatanId){
         ...
         <div class="card">
                    <div class="card-header">
                        <h5>Form Edit Proposal</h5>
                    </div>


                    <div class="card-body">
                    <form method="POST"  action="{{ route('proposal.proposal.postakhir', $data->id) }}" enctype="multipart/form-data">
                            @csrf                             @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-7 mb-3">
                                    <label class="form-label" for="validationDefault02">File Proposal  @if($data->proposal!='')
                        ...
                        <div class="row g-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control" type="date" name="tanggal_input_survey" value="{{ $data->tanggal_input_survey }}" >    
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label class="form-label" for="validationDefault02">Petugas Survey</label>
                                    <select class="form-control px-15"  name="petugas_survey" id="exampleFormControlSelect1" required="">
                       ...
                       <div class="col-md-5 mb-3">
                                    ...
                                    <select class="form-control px-15" name="status_akhir" id="exampleFormControlSelect1" required="">
