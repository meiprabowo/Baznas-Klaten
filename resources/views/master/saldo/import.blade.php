                    ...
                    <div class="col-lg-12">
                        <div class="shop-breadcrumb">
                            ...
                            <div class="breadcrumb-main">
                                <h4 class="text-capitalize breadcrumb-title">Import Saldo Awal</h4>
                                <div class="breadcrumb-action justify-content-center flex-wrap">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#"><i class="las la-home"></i>Import Saldo Awal</a></li>
...
@endif
         <div class="card">
                    <div class="card-header">
                        <h5>Form Import Saldo Awal</h5>
                    </div>


                    <div class="card-body">
                        <form method="POST" action="{{ route('master.saldo.importstore') }}" enctype="multipart/form-data">
                            @csrf
                          <div class="row g-3">
                            <div class="col-md-6 mb-3">
                              <label class="form-label" for="validationDefault01">Import Saldo Awal</label>
                              <input class="form-control" type="file" name="file">
                              <span><code class="text-danger">Download template <a href="{{ route('master.saldo.export') }}" target="_blank"> ==> <b>DOWNLOAD</b> <== </a></code> <br/></span>
