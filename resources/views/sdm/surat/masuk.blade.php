                            ...
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    <div class="project-search order-search  global-shadow mt-10">
                                        <form action="{{ route('sdm.surat.cari') }}" class="order-search__form">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('sdm.surat.export',['keyword'=>request('keyword')]) }}">  <button type="button" class="btn btn-warning btn-xs btn-squared">Export</button></a>

                                    <a href="{{ route('sdm.surat.tambah') }}">  <button type="button" class="btn btn-info btn-xs btn-squared">Tambah Data</button></a>
</div>
                                </div>
                            </div>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap float-end">
                                               ...
                                               @if($d->lampiran!='')
                                                <li>
                                                   <a href="{{ url('/surat/'.$d->lampiran) }}" target="_blank" class="view">
                                               ...
                                               @endif
                                                  ...
                                                  <li>
                                                      <a href="{{ route('sdm.surat.editmasuk', $d->id) }}" class="edit">
