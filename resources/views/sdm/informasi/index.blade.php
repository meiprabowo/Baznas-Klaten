                            ...
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    <div class="project-search order-search  global-shadow mt-10">
                                        <form action="{{ route('sdm.informasi.search') }}" class="order-search__form">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('sdm.informasi.create') }}">  <button type="button" class="btn btn-info btn-xs btn-squared">Tambah Data</button></a>
</div>
                                </div>
                            </div>
                    ...
                    <?php $no=1; ?>
                     ...
                     <tr>
                        ...
                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap float-end">
                                               ...
                                               <li>
                                                   <a href="{{ route('sdm.informasi.edit', $d->id) }}" class="edit">
                                                       <i class="uil uil-edit"></i>
                                                   </a>
                                                 
                                               </li>
                                               <li>
                                                   <a href="{{ route('sdm.informasi.destroy', $d->id) }}"  onclick="return confirm('Apakah Anda Yakin ?');"  class="remove">
