                            ...
                            <div class="breadcrumb-main">
                                ...
                                <div class="breadcrumb-action justify-content-center flex-wrap">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#"><i class="las la-home"></i>Pengesahan </a></li>
                        ...
                        <div class="userDatatable orderDatatable sellerDatatable global-shadow mb-30 py-30 px-sm-30 px-20 radius-xl w-100">
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('sdm.tasaruf.tambahpengajuansdm') }}">  <button type="button" class="btn btn-primary btn-xs btn-squared">Tambah</button></a>
</div>
                                </div> 
                            </div>
                                ...
                                <table class="table mb-0 table-borderless border-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $d->keterangan }}</td>
                                            ...
                                            <li>
                                                <a href="{{ route('sdm.tasaruf.cetakdetaillihatpengajuansdm', $d->id) }}" class="view">
                                                   <i class="uil uil-print"></i>
                                                </a>
                                             </li>

                                             <li>
                                                <a href="{{ route('sdm.tasaruf.detaillihatpengajuansdm', $d->id) }}" class="view">
                                                   <i class="uil uil-folder"></i>
                                                </a>
                                             </li>
                                   
                                             <li>
                                                <a href="{{ route('sdm.tasaruf.hapuspengajuansdm', $d->id) }}"  onclick="return confirm('Apakah Anda Yakin ?');"  class="view">
