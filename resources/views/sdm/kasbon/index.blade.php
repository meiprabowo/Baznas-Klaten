...
<div class="container-fluid">
    ...
    @endif
                            ...
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    <div class="project-search order-search  global-shadow mt-10">
                                        <form action="{{ route('sdm.kasbon.search') }}" class="order-search__form">
                                ...
                                <div class="content-center">
                                    ...
                                    <a href="{{ route('sdm.kasbon.export',['keyword'=>request('keyword')]) }}">  <button type="button" class="btn btn-warning btn-xs btn-squared">Export</button></a>

                                    <a href="{{ route('sdm.kasbon.create') }}">  <button type="button" class="btn btn-info btn-xs btn-squared">Tambah Data</button></a>
</div>
                                </div>
                            </div>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        ?>
                          ...
                          <li>
                                                   <a href="{{ route('sdm.kasbon.cetakkeuangan', $d->id) }}" class="detail">
                                                       <i class="uil uil-print"></i>
                                                   </a>
                                                </li>
                                                      <li>
                                                   <a href="{{ route('sdm.kasbon.edit', $d->id) }}" class="edit">
                                                       <i class="uil uil-edit"></i>
                                                   </a>
                                               </li>
                                               <li>
                                                   <a href="{{ route('sdm.kasbon.destroy', $d->id) }}"  onclick="return confirm('Apakah Anda Yakin ?');"  class="remove">
               ...
               ?>
                         <a href="{{ route('sdm.kasbon.cetakkeuangan', $d->id) }}">    <span class="badge rounded-pill badge-success">{{ $tgl }}</span></a>
                           <?php } ?>
