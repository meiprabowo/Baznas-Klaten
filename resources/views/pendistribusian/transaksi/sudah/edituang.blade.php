                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="breadcrumb-main">
                                <h4 class="text-capitalize breadcrumb-title">Detail SPJ Tasaruf </h4>
        ...
        if(kecamatanId){
         ...
         <div class="card">
                    <div class="card-header">
                        <h5>Form Edit Tasaruf ( Uang )</h5>
                    </div>


                    <div class="card-body">
                    <form method="POST"  action="{{ route('pendistribusian.tasaruf.pedituang', $data->id) }}" enctype="multipart/form-data">
                    @csrf                             @method('PUT')
...
<div class="col-md-2 mb-3">
    ...
    <div class="col-md-4">
                                    ...
                                    <div class="dm-select ">
                                        ...
                                        <option value="{{ $d->id }}" {{ $data->kredit == $d->id ? 'selected' : '' }} > {{ $d->uraian }}</option>
                                        @endforeach
                                      </select>
                                    </div>  
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" type="text" name="nominal"  value="{{ number_format($data->jumlah, 0, ',', '.') }}" oninput="formatNominal(this)">
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label" for="validationDefault02">Program</label>
                                        <select class="form-control px-15" id="program" name="program" id="exampleFormControlSelect1" required="">
                                            ...
                                            <option value="{{ $pro->kode }}"  {{ $hasil->pro_utama == $pro->kode ? 'selected' : '' }} >{{ $pro->uraian }}</option>
                                            @endforeach
                                        </select>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label" for="validationDefault02">Sub Program</label>
                                        <select class="form-control px-15" id="subprogram" name="subprogram" id="exampleFormControlSelect1" required="">
                                            ...
                                            <option value="{{ $sub->kode }}"  {{ $hasil->sub_utama == $sub->kode ? 'selected' : '' }} >{{ $sub->uraian }}</option>
                                            @endforeach
                                        </select>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-control px-15" id="detailprogram" name="detailprogram" id="exampleFormControlSelect1" required="">
                                            ...
                                            <option value="{{ $del->id }}"  {{ $data->debet == $del->id ? 'selected' : '' }} >{{ $del->uraian }}</option>
                                            @endforeach
