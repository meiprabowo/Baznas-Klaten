...
@endif
         <div class="card">
                    ...
                    <div class="card-body">
                    <form method="POST"  action="{{ route('pendistribusian.pembelian.update', $data->id) }}" enctype="multipart/form-data">
                            @csrf                             @method('PUT')
                            <div class="row g-3">
                            ...
                            <div class="row g-3">
                                 <div class="col-md-12 mb-3">
                                    <label class="form-label" for="validationDefault02">Nama Barang</label>
                            ...
                            <div class="col-md-1 mb-3">
                                    <label class="form-label" for="validationDefault02">QTY</label>
                                    <input class="form-control" id="validationDefault01" type="text" name="qty"   value="{{ $data->qty }}" placeholder="QTY">
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 mb-3">
                                  <label class="form-label" for="validationDefault02">File                                  @if($data->file!='')
                                  <a class="pdf" href="{{ url('/pembelian/'.$data->file) }}" target="_blank"><i class="icofont icofont-file-pdf"> </i> <b> ==> Download <== </b></a>
                                  @endif
</label>
