...
@endif
         <div class="card">
                    <div class="card-header">
                        <h5>Form Tambah Pembelian Barang </h5>
                    </div>


                    <div class="card-body">
                        <form method="POST" action="{{ route('pendistribusian.pembelian.store') }}" enctype="multipart/form-data">
                        @csrf
                            <div class="row g-3">
                            ...
                            <div class="row g-3">
                                <div class="col-md-1 mb-3">
                                    ...
                                    <input class="form-control" id="validationDefault01" type="text" name="qty" placeholder="QTY">
                                </div>
